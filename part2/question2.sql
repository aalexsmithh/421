...
create table coupons(
	couponCode int NOT NULL PRIMARY KEY,
	pName text NOT NULL,
...
create table transactions(
	...
	cashierID int,
	FOREIGN KEY(cashierID) REFERENCES cashiers(employeeID)
	);
...
create table shifts(
	...
	FOREIGN KEY(employeeID) REFERENCES employees(employeeID),
	FOREIGN KEY(wageID) REFERENCES transactions(transactionID),
	FOREIGN KEY(managerID) REFERENCES managers(employeeID),
	PRIMARY KEY(shiftDate,employeeID)
	);

create table deliveryvehicles(
	licenseNo char(7) NOT NULL PRIMARY KEY,
	currentdriverID int NOT NULL,
	FOREIGN KEY(currentDriverID) REFERENCES deliverydrivers(employeeID)
	);